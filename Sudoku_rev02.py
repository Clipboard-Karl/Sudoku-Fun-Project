# Sudoku_rev02.py - Sudoku Problem solver
#
#  20200730 - Successfully check and solving if a row has a single zero
#               Saving this and moving to Sudoku_rev03.py for columns :)
